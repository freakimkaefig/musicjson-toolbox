...
n.push({similarity:this.arrayEditDistance(this.valueMapping(i[r]),e),highlight:this.highlightMapping(i[r])})}return n},pitchDurationNgramSimilarity:function(t,e,i){for(var n=parseInt(t.attributes.divisions),r=parseInt(t.attributes.time["beat-type"]),a=parseInt(t.attributes.key.fifths),s=this.ngrams(this.notes(t,!1,!0),2*e.length),h=[],u=0;u<s.length;u++)h.push({similarity:this.weightedEditDistance(this.pitchDurationValues(s[u],a,n,r),e,i),highlight:this.highlightMapping(s[u])})
return h}}
