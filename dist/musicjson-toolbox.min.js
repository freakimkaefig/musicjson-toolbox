...
var h=a/s,u=0,o=1/0
for(r=0;r<e.length;r++)u<e[r].duration&&(u=e[r].duration)
...
else{var c=n[i-1][r-1]+this.weightSubstitution(t,e,i,r),l=n[i][r-1]+this.weightInsertion(e,r),g=n[i-1][r]+this.weightDeletion(t,i),d=this.weightFragmentation(n,t,e,i,r,h),p=this.weightConsolidation(n,t,e,i,r,f),v=Math.min(c,l,g,d,p)
n[i][r]=v}return 1-n[t.length][e.length]/Math.max(n[t.length][0],n[0][e.length])},weightSubstitution:function(t,e,i,n){var r=this.weightInterval(t[i-1],e[n-1]),a=this.weightLength(t[i-1].duration,e[n-1].duration),s=r+this.globalK*a
return s},weightInsertion:function(t,e){return this.globalK*t[e-1].duration},weightDeletion:function(t,e){return this.globalK*t[e-1].duration},weightFragmentation:function(t,e,i,n,r,a){var s,h,u=2,o=Math.min(r-1,a),f=1/0
for(s=u;o>=s;s++){h=s
for(var c=t[n-1][r-h],l=0;h>0;){var g=this.weightInterval(e[n-1],i[r-h])
c+=g,l+=i[r-h].duration,h--}var d=this.weightLength(e[n-1].duration,l)
c+=this.globalK*d,f>c&&(f=c)}return f},weightConsolidation:function(t,e,i,n,r,a){var s,h,u=2,o=Math.min(n-1,a),f=1/0
for(s=u;o>=s;s++){h=s
for(var c=t[n-h][r-1],l=0;h>0;){var g=this.weightInterval(e[n-h],i[r-1])
c+=g,l+=e[n-h].duration,h--}var d=this.weightLength(l,i[r-1].duration)
...
n.push({distance:this.arrayEditDistance(this.valueMapping(i[r]),e),highlight:this.highlightMapping(i[r])})}return n},distancePitchDurationNgrams:function(t,e){for(var i=parseInt(t.attributes.divisions),n=parseInt(t.attributes.time["beat-type"]),r=parseInt(t.attributes.key.fifths),a=this.ngrams(this.notes(t,!1,!0),2*e.length),s=[],h=0;h<a.length;h++)s.push({distance:this.weightedEditDistance(this.pitchDurationValues(a[h],r,i,n),e),highlight:this.highlightMapping(a[h])})
return s}}
