...
for(var i=1;i<t.length;i++){var n=this.pitchDifference(t[i-1].pitch,0,t[i].pitch,!0,!1),r=this.durationDifference(t[i-1].duration,t[i].duration,!1),a={value:n,duration:r,noteNumber:t[i].noteNumber,measureNumber:t[i].measureNumber}
...
n=r>0?"u":0>r?"d":"r",e.push({value:n,noteNumber:t[i].noteNumber,measureNumber:t[i].measureNumber})}return e},ngrams:function(t,e){for(var i=[],n=0;n<t.length-(e-1);n++){for(var r=[],a=0;e>a;a++)r.push(t[n+a])
...
for(a=0;a<e.length;a++)h>e[a].duration&&(h=e[a].duration)
var u=s/h,o=0,l=1/0
...
else{var c=r[n-1][a-1]+this.weightSubstitution(t,e,n,a,i),g=r[n][a-1]+this.weightInsertion(e,a,i),p=r[n-1][a]+this.weightDeletion(t,n,i),d=this.weightFragmentation(r,t,e,n,a,u,i),v=this.weightConsolidation(r,t,e,n,a,f,i),b=Math.min(c,g,p,d,v)
r[n][a]=b}var m=-(1/0)
for(n=0;n<r.length;n++){var D=Math.max.apply(null,r[n])
D>m&&(m=D)}return(m-r[t.length][e.length])/m},weightSubstitution:function(t,e,i,n,r){var a=this.weightInterval(t[i-1],e[n-1],r),s=this.weightLength(t[i-1].duration,e[n-1].duration),h=r?this.globalK1:this.globalK,u=a+h*s
return u},weightInsertion:function(t,e,i){var n=i?this.globalK3:this.globalK
return n*parseFloat(t[e-1].duration)},weightDeletion:function(t,e,i){var n=i?this.globalK3:this.globalK
return n*t[e-1].duration},weightFragmentation:function(t,e,i,n,r,a,s){var h,u,o=2,l=Math.min(r-1,a),f=1/0,c=s?this.globalK1:this.globalK
for(h=o;l>=h;h++){u=h
for(var g=t[n-1][r-u],p=0;u>0;){var d=this.weightInterval(e[n-1],i[r-u],s)
g+=d,p+=i[r-u].duration,u--}var v=this.weightLength(e[n-1].duration,p)
g+=c*v,f>g&&(f=g)}return f},weightConsolidation:function(t,e,i,n,r,a,s){var h,u,o=2,l=Math.min(n-1,a),f=1/0,c=s?this.globalK1:this.globalK
for(h=o;l>=h;h++){u=h
for(var g=t[n-u][r-1],p=0;u>0;){var d=this.weightInterval(e[n-u],i[r-1],s)
g+=d,p+=e[n-u].duration,u--}var v=this.weightLength(p,i[r-1].duration)
g+=c*v,f>g&&(f=g)}return f},weightInterval:function(t,e,i){if("true"===t.rest||t.rest===!0||"true"===e.rest||e.rest===!0)return.1
var n=t.value%12
0===n&&(n=12)
var r=e.value%12
...
n.push({distance:this.arrayEditDistance(this.valueMapping(i[r]),e),highlight:this.highlightMapping(i[r])})}return n},distancePitchDurationNgrams:function(t,e,i){for(var n=parseInt(t.attributes.divisions),r=parseInt(t.attributes.time["beat-type"]),a=parseInt(t.attributes.key.fifths),s=this.ngrams(this.notes(t,!1,!0),2*e.length),h=[],u=0;u<s.length;u++)h.push({distance:this.weightedEditDistance(this.pitchDurationValues(s[u],a,n,r),e,i),highlight:this.highlightMapping(s[u])})
return h}}
