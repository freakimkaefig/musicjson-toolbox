...
D>m&&(m=D)}return(m-r[t.length][e.length])/m},weightSubstitution:function(t,e,i,n,r){var a=this.weightInterval(t[i-1],e[n-1],r),s=this.weightLength(t[i-1].duration,e[n-1].duration),u=r?this.globalK1:this.globalK,h=a+u*s
